This is when the source code is translated into executable code (machine code, bytecode, etc.) by a compiler. Compile-time errors, such as syntax errors, are caught during this phase.
