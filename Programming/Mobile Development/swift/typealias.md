Logical equivalent to a `typedef` within `C` and `C++` . It is utilized to create a name for an existing type which allows for later instantiation utilizing that `typealias` . 
#### Syntax
```swift
