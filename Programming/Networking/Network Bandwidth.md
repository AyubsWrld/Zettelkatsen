Measures the maximum amount of data which can be transmitted over a network connection over some amount of time it is usually measured in *bits per second* (bps) . 
