Unordered collection of objects , that is $\{ 1, 2 , 3 \}$ is equivalent to $\{ 2, 1 , 3 \}$ . Sets can be defined utilizing by explicitly defining its members or through defining a rule which identifies its members . 
